      ...
      <div className="flex flex-col justify-end gap-0">
        {chapter.experience && (
          <div style={{ borderTop: '1px solid rgba(0,0,0,0.08)', paddingTop: '18px', marginBottom: '16px' }}>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(252,163,17,0.6)', marginBottom: '10px' }}>{labels.experience}</p>
        ...
        {chapter.education && (
          <div style={{ borderTop: '1px solid rgba(0,0,0,0.08)', paddingTop: '18px' }}>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(252,163,17,0.6)', marginBottom: '10px' }}>{labels.education}</p>
